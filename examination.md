...
ошибка сети Em.
2. Инициализируются случайным образом весовые коэффициенты w_ij (от i-го к j-тому) и
пороговые bi значения R элементов.
...
5. Если E>Em, то производится изменение весовых коэффициентов и порогов нейронных
элементов и выполняется переход к шагу 3, иначе выполнение
